...
Mobile.tap(findTestObject('android.widget.Button (1)'), 0)

Mobile.setText(findTestObject('android.widget.Button (1)'), 'receptionist@kaf.co.id', 0)

Mobile.hideKeyboard()

Mobile.tap(findTestObject('Object Repository/android.widget.EditText (1)'), 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText (1)'), 'R3cept!#888', 0)
